<?php 
	...
	class woocaseproCarouselClassicV2Style implements woocaseproViewInterface{
		...
		public function woocase_view(){
			...
			if($this->query->have_posts()) : ?>
					...
					<section class="woocase-carousel-default-css woocase-carousel-section woocase-carousel-version-6 section-padding">
						<div class="woocase-carousel-container">
							<div class="owl-carousel owl-theme woocase-carousel-classic-version-unique-2">
							...
							<?php if($this->woocase_args['woocase_navigation']) : ?>
								<div class="customNavigation">
									<a class="next"><img src="<?php echo esc_attr( plugins_url('assets/images/carousel-next-arrow.png', dirname(__DIR__)) ); ?>" alt="Next"></a>
									<a class="prev"><img src="<?php echo esc_attr( plugins_url('assets/images/carousel-prev-arrow.png', dirname(__DIR__)) ); ?>" alt="Prev"></a>
								</div>
							<?php endif; ?>
					...
					<script type="text/javascript">
						    ...
						    (function(){
						    	jQuery(document).on('ready', function(){
						    		jQuery(".woocase-carousel-classic-version-unique-2").each(function(){
