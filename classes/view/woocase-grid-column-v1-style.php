<?php 
	...
	class woocaseproGridColumnV1Style implements woocaseproViewInterface{
		...
		public function woocase_view(){
			...
			if($this->query->have_posts()) : ?>
				...
				?>
					...
					<section class="woocase-carousel-default-css woocase-carousel-section woocase-carousel-version-8 <?php echo esc_attr( $this->gridColumn ); ?> woocase-grid-colomn-sp section-padding">
											...
											<figure class="woocase-carousel-elements">
												...
												<figcaption class="woocase-carousel-text-content">
													...
													<div class="woocase-carousel-btn-group">
														...
														<?php if($this->woocase_args['woocase_type'] !== 'woocase-4-column-grid') : ?>
